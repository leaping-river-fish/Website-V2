...
interface DialogueBoxProps {
    nodes?: Record<string, DialogueNode>;  // Optional: for automatic navigation
    onContinue?: () => void;               // Custom continue handler
    onChoiceSelect?: (choice: DialogueChoice) => void;  // Custom choice handler
}
...
export function DialogueBox({ nodes, onContinue, onChoiceSelect }: DialogueBoxProps) {
    ...
    return (
        <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 w-11/12 md:w-2/3 lg:w-1/2 z-50 pointer-events-none">
