                ...
                >
                    ...
                    >
                        <Link 
                            ...
                            className={`
                                ...
                                ${currentRoute === "/about"
                                    ? "text-transparent bg-clip-text bg-linear-to-r from-[#333333] to-[#dd1818]"
                        ...
                        <button
                            ...
                            className="ml-4 text-lg font-bold hover:text-slate-300"
                    ...
                    {isCollapsed && (
                        <button
                            ...
                            className="ml-3 text-lg font-bold hover:text-slate-300"
